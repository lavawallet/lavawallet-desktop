...
module.exports = class ContractInterface  {
  ...
  static getContract(web3Provider,env,contractName,contractAddress)
  {
    ...
    {
      return new web3Provider.eth.Contract(tokenContractJSON.abi,contractAddress)
    }

    if(contractName == 'erc20token_approveAndCall')
    {
      return new web3Provider.eth.Contract(approveCallTokenContractJSON.abi,contractAddress)
    }

    if(contractName == 'lava')
    {
      return new web3Provider.eth.Contract(lavaContractJSON.abi,contractAddress)
    }
  }
  ...
  static getTokenContract(web3Provider,address)
  {
    ...
    return new web3Provider.eth.Contract(tokenContractJSON.abi,address)
  }
  ...
  static getLavaContract(web3Provider, address)
  {
    ...
    return new web3Provider.eth.Contract(lavaContractJSON.abi,address)
  }
